...
{
  //dark swatch
  static const Color primaryColor = Color(0xff680d84);
  static const Color accentColor = Color(0xFFffa978);
  static const Color secondaryColor = Color(0xFF2f05ad);

  static const Color iconSecondaryColor = Color(0xFF08dab7);
  ...
  static const Color messageItemColor = Color(0xffe1e1e1);
