...
class LightTheme extends AppTheme {
  LightTheme({
    Color flashingCircleDarkColor = const Color(0xff680d84),
    ...
    Color backArrowColor = const Color(0xff680d84),
    ...
    Color replyTitleColor = const Color(0xff680d84),
    ...
    Color verticalBarColor = const Color(0xff680d84),
